...
void printToAndroid() {
    ...
    Serial.print(";");
    Serial.print(String(alt_m1));
    Serial.print(";");
    Serial.print(String(alt_feet1));
    Serial.print(";");
    Serial.print(String(humidity1));
    Serial.print(";BME2;");
    Serial.print(String(temp2));
    Serial.print(";");
    Serial.print(String(pressure2));
    Serial.print(";");
    Serial.print(String(alt_m2));
    Serial.print(";");
    Serial.print(String(alt_feet2));
    Serial.print(";");
    Serial.print(String(humidity2));
    Serial.print(";BME3;");
    Serial.print(String(temp3));
    Serial.print(";");
    Serial.print(String(pressure3));
    Serial.print(";");
    Serial.print(String(alt_m3));
    Serial.print(";");
    Serial.print(String(alt_feet3));
    Serial.print(";");
    Serial.print(String(humidity3));
    Serial.print(";BME4;");
    Serial.print(String(temp4));
    Serial.print(";");
    Serial.print(String(pressure4));
    Serial.print(";");
    Serial.print(String(alt_m4));
    Serial.print(";");
    Serial.print(String(alt_feet4));
    Serial.print(";");
    Serial.print(String(humidity4));
    Serial.println();
