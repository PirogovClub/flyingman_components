import 'dart:convert';
import 'package:flyingmanPoc1/controls/AniControl.dart';
import 'package:flyingmanPoc1/controls/Animation.dart';
import 'package:flyingmanPoc1/utils/Storage.dart';
import 'package:flyingmanPoc1/widgets/CountBtnPage.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageView(
        ...
        children: [Compass(), Earth(), WriteToFile()],
      ),
    );
  }
}
